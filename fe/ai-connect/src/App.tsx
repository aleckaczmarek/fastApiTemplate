...
function App() { 
  ...
  return ( 
        <div style={{display:'flex', flexDirection:'column'}}> 
          <textarea onChange={(e)=>setQuestion(e.target.value)} style={{minHeight:'320px', minWidth:'90vw'}} />
          <button disabled={sending} onClick={getChatResponse} style={{marginBottom:'32px', marginTop:'24px'}}>Ask A question :)</button>
